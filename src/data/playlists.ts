...
export const practicePlaylists: PracticePlaylist[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { title: 'Binary Tree DFS -- Return & Combine Skeleton', coreShape: 'Trees', methods: ['null base case', 'left / right recursion', 'postorder return', 'combine child results'] },
      { title: 'Binary Tree DFS -- Carry State Skeleton', coreShape: 'Trees', methods: ['root-to-node state', 'preorder processing', 'branch-local state', 'left / right recursion'] },
      { title: 'Binary Tree BFS -- Level Order Skeleton', coreShape: 'Trees', methods: ['queue frontier', 'level-size snapshot', 'left / right child expansion', 'per-level aggregation'] },
      ...
      { title: "Topological Sort -- Kahn's Algorithm Skeleton", coreShape: 'Graphs', methods: ['indegree bookkeeping', 'zero-indegree queue', 'cycle detection'] },
      { title: 'Trie Skeleton', coreShape: 'Trie', methods: ['child map', 'word insertion', 'exact search'] },
      { title: 'Backtracking Skeleton', coreShape: 'Backtracking', methods: ['choose / explore / undo', 'valid choices', 'goal state'] },
      { title: 'Dijkstra Skeleton', coreShape: 'Graphs', methods: ['min-heap frontier', 'non-negative weights', 'finalized distances'] },
      { title: 'Two Pointers Skeleton', coreShape: 'Two Pointers', methods: ['opposing pointers', 'movement rule', 'termination condition'] },
      { title: 'Heap / Top-K Skeleton', coreShape: 'Heap / Priority Queue', methods: ['min heap', 'top-k maintenance', 'push / pop discipline'] },
      ...
      { title: 'Prefix Sum Skeleton', coreShape: 'Prefix Sums', methods: ['leading zero', 'running total', 'range difference'] },
      { title: 'Monotonic Stack Skeleton', coreShape: 'Monotonic Stack', methods: ['index stack', 'pop trigger', 'next greater element'] },
      { title: 'Divide and Conquer Skeleton', coreShape: 'Divide and Conquer', methods: ['base case', 'divide', 'combine'] },
      { title: 'Greedy Skeleton', coreShape: 'Greedy', methods: ['sorting rule', 'local choice', 'feasibility check'] },
